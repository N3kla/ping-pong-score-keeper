...
Interactive ping-pong (table tennis) score tracker built with **vanilla JavaScript**, HTML, and CSS.

## Live Demo
[Play here!](https://n3kla.github.io/ping-pong-score-keeper/)

## Features
- Real table tennis scoring rules (win by reaching selected score with at least a 2-point lead)
- Select winning score from dropdown
- Visual feedback: winning player turns green, loser red
- Responsive design (works on mobile)
- Clean, modern UI with hover effects
- Buttons disable after win for better UX
